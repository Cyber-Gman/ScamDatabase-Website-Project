...
:NameofScammer, :ScamCompany,
:DateofScam, :PhoneNumber)";

$stmt = $pdo->prepare($sql);

// Bind parameters to statement
$stmt->bindParam(':NameofScammer', $_REQUEST['NameofScammer']);
$stmt->bindParam(':ScamCompany', $_REQUEST['ScamCompany']);
$stmt->bindParam(':DateofScam', $_REQUEST['DateofScam']);
